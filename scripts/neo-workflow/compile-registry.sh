...
CONTRACT="$PROJECT_ROOT/contracts/ReceivableRegistryV2.py"
OUT_DIR="$PROJECT_ROOT/build"
OUT_NEF="$OUT_DIR/ReceivableRegistryV2.nef"

mkdir -p "$OUT_DIR"

echo "🛠  Compiling ReceivableRegistryV2 contract with neo3-boa..."
echo ""
...
NEF="$OUT_NEF"
MANIFEST="$OUT_DIR/ReceivableRegistryV2.manifest.json"
