...
CONTRACT="$PROJECT_ROOT/contracts/ExporterRegistry.py"
OUT_DIR="$PROJECT_ROOT/build"
OUT_NEF="$OUT_DIR/ExporterRegistry.nef"

mkdir -p "$OUT_DIR"

echo "🛠  Compiling ExporterRegistry contract with neo3-boa..."
echo ""
...
NEF="$OUT_NEF"
MANIFEST="$OUT_DIR/ExporterRegistry.manifest.json"
