...
CONTRACT="$PROJECT_ROOT/contracts/InvestorShare.py"
OUT_DIR="$PROJECT_ROOT/build"
OUT_NEF="$OUT_DIR/InvestorShare.nef"

mkdir -p "$OUT_DIR"

echo "🛠  Compiling InvestorShare contract with neo3-boa..."
echo ""
...
NEF="$OUT_NEF"
MANIFEST="$OUT_DIR/InvestorShare.manifest.json"
